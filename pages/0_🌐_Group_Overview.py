...
with st.sidebar:
    ...
    sel_streams = st.multiselect("Streams", streams_avail, default=streams_avail, key="grp_streams")

    years_avail = sorted(all_df['Year'].dropna().astype(int).unique().tolist())
    sel_years = st.multiselect("Years", years_avail, default=years_avail, key="grp_years")
